...
<?php endif; ?>
    ...
    <!-- ***** Menu Area Starts ***** -->
        <?php echo $__env->make('foodsection', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ***** Menu Area Ends ***** -->
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="logo">
                        <a href="<?php echo e(url('/')); ?>"><img src="assets/images/white-logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
...
</html><?php /**PATH C:\xampp\htdocs\resturant\resources\views/home.blade.php ENDPATH**/ ?>